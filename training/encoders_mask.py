...
class StabilityVAEEncoder(Encoder):
    def __init__(self,
        ...
        raw_mean = [6.705464, 2.9343288, 2.9535122, 0.4848446],
        raw_std = [2.6266587, 3.886684, 5.0597553, 3.3853426],
...
def load_stability_vae(vae_name="./pretrained_model/sd-vae-ft-mse", device=torch.device('cpu')):
